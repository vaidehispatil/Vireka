    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4">Rings</h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8">Stunning rings for every style</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        {rings.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-gray-400 text-xl">No rings available at the moment.</p>
          </div>
        )}
      </div>
    </div>
